...
/*
   ¶¯»­º¯Êý animate (obj,attrObj,dur,fun,callback)
   obj   Òª¶¯»­µÄ¶ÔÏó
   attrobj   Òª¶¯»­µÄÊôÐÔ¶ÔÏó{width:xxxx,height:xxx,left:xxxx,top:xxxx,opacity:xxx}
   dur   ³ÖÐøÊ±¼ä
   fun   ¶¯»­·½Ê½
   callback ±ä»¯Íê³ÉÖ®ºóÒª´¦ÀíµÄÄÚÈÝ
*/
/*
  º¯Êý colorAnimate (obj,attr,val,dur,fn,callback)
  obj   Òª´¦ÀíµÄ¶ÔÏó
  attr  Òª´¦ÀíµÄÊôÐÔ  background   color
  val   ×îÖÕÑÕÉ« rbg    #
  fn    ¶¯»­µÄ·½Ê½
  callback  ±ä»¯Íê³ÉÖ®ºóÒª´¦ÀíµÄÄÚÈÝ
*/
